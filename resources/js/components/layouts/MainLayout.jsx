    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f8fafc', fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <style>{`
        ...
        * { cursor: none !important; }
        ...
        .mora-social-icon.yt:hover { background: #ff0000; border-color: #ff0000; color: #fff; transform: translateY(-3px); }
      ...
      <footer className="mora-footer" aria-label="Site footer">
        ...
        <div className="mora-footer-main">
          ...
          <nav className="mora-footer-col" aria-label="Services">
            ...
            <Link href={toServiceUrl('web-development')} className="mora-footer-col-link">Web Development</Link>
            <Link href={toServiceUrl('app-development')} className="mora-footer-col-link">App Development</Link>
            <Link href={toServiceUrl('ui-ux-design')} className="mora-footer-col-link">UI/UX Design</Link>
            <Link href={toServiceUrl('php-laravel')} className="mora-footer-col-link">PHP Laravel</Link>
            <Link href={toServiceUrl('react-js')} className="mora-footer-col-link">React.js</Link>
            <Link href={toServiceUrl('flutter-apps')} className="mora-footer-col-link">Flutter Apps</Link>
          </nav>
        ...
        <div className="mora-footer-bottom">
          ...
          <div className="mora-footer-socials">
              {footer.facebook && (
                <a href={footer.facebook} target="_blank" rel="noopener noreferrer" className="mora-social-icon fb" aria-label="Facebook">
              ...
              {footer.twitter && (
                <a href={footer.twitter} target="_blank" rel="noopener noreferrer" className="mora-social-icon tw" aria-label="Twitter / X">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              {footer.youtube && (
                <a href={footer.youtube} target="_blank" rel="noopener noreferrer" className="mora-social-icon yt" aria-label="YouTube">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              {footer.instagram && (
                <a href={footer.instagram} target="_blank" rel="noopener noreferrer" className="mora-social-icon ig" aria-label="Instagram">
                  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

...
const HERO_SLIDES = [
  { url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1920&q=90&fit=crop', label: 'Digital Solutions' },
  { url: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1920&q=90&fit=crop', label: 'Business Growth' },
  { url: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1920&q=90&fit=crop', label: 'Expert Team' },
  { url: 'https://images.unsplash.com/photo-1547658719-da2b51169166?w=1920&q=90&fit=crop', label: 'Web Development' },
];
  ...
  return (
    <section className="sd-hero">
      {HERO_SLIDES.map((slide, i) => (
        <div key={i} className="sd-slide-base" style={{ backgroundImage: `url(${slide.url})`, opacity: i === current ? 1 : 0, zIndex: i === current ? 1 : 0 }} />
      ))}
      ...
      <div className="sd-hero-inner">
        ...
        {subtitle && (
          <p className="sd-hero-sub" data-aos="fade-up" data-aos-delay="160">{subtitle}</p>
        )}
        <div className="sd-hero-cta-row" data-aos="fade-up" data-aos-delay="220">
          ...
          <Link href="/services" className="sd-hero-ghost-btn">All Services</Link>
        </div>
      </div>
      <button className="sd-slider-arrow sd-arrow-left" onClick={goBack} aria-label="Previous slide">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M19 12H5M12 19l-7-7 7-7" /></svg>
      </button>
      <button className="sd-slider-arrow sd-arrow-right" onClick={next} aria-label="Next slide">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
      </button>
      <div className="sd-dot-row">
        {HERO_SLIDES.map((_, i) => (
          <button key={i} onClick={() => goTo(i)} className={`sd-dot${i === current ? ' sd-dot-active' : ''}`} aria-label={`Slide ${i + 1}`} />
        ))}
      </div>
    </section>
  );
...
export default function ServiceDetailPage({ service, related = [], setting = null }) {
  ...
  const defaultFeatures = [
    ...
    'Fast delivery with regular updates',
  ...
  const keywords = service.meta_keyword
    ? service.meta_keyword.split(',').map(k => k.trim()).filter(Boolean)
    : [];
  ...
  return (
    <main className="sd-root">
      ...
      {/* ── HERO ── */}
      <HeroSlider title={service.title} subtitle={service.subtitle} priceRange={service.price_range} ctaText={service.cta_text} />
      ...
      <div className="sd-body">
        ...
        <div className="sd-grid">
          ...
          <div className="sd-left-col">
            ...
            {/* Overview */}
            <div className="sd-card" data-aos="fade-up">
              ...
              {service.description ? (
                ...
                <p className="sd-desc-text">Professional {service.title} services tailored to your business needs. We deliver high-quality solutions with fast turnaround times and exceptional support.</p>
              )}
            </div>

            {/* What's Included */}
            <div className="sd-card" data-aos="fade-up" data-aos-delay="80">
              <div className="sd-card-header">
            ...
            {/* Process */}
            <div className="sd-card" data-aos="fade-up" data-aos-delay="120">
              <div className="sd-card-header">
          ...
          <aside className="sd-sidebar">
            ...
            {/* CTA Card */}
            <div className="sd-cta-card" data-aos="fade-left">
            ...
            {/* Quick Info */}
            <div className="sd-side-card" data-aos="fade-left" data-aos-delay="80">
...
>
    ...
    Back
          ...
          </aside>{/* end .sd-sidebar */}

        </div>{/* end .sd-grid */}

        {/* ── RELATED SERVICES ── */}
        {related.length > 0 && (
          <div className="sd-related-section" data-aos="fade-up">
              ...
              {related.map((s, i) => (
                <Link key={s.id} href={toServiceUrl(s.slug)} className="sd-related-card" data-aos="zoom-in" data-aos-delay={i * 60}>
                  <div className="sd-related-card-top">
                    ...
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6366f1" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                  </div>
        ...
        {/* ── BOTTOM BANNER ── */}
        <div className="sd-bottom-banner" data-aos="fade-up">

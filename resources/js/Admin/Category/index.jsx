...
function CreateModal({ onClose, onSuccess }) {
    const [form, setForm] = useState({ name: '', text_for: '', slug: '' });
        ...
        >
            <div style={{
                ...
                <h3 style={{
                    ...
                    marginBottom: '0.4rem', letterSpacing: '-0.4px',
                }}>
                    Create New Category
                </h3>
                <p style={{
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '0.95rem' }}>
                        ...
                        <input
                            ...
                            onBlur={(e) => {
                                e.target.style.borderColor = errors.name ? '#f87171' : '#e2e8f0';
                    ...
                    <div style={{ marginBottom: '0.95rem' }}>
                        ...
                        <select
                            value={form.text_for}
                            onChange={(e) => setForm({ ...form, text_for: e.target.value })}
                            style={{
                                width: '100%',
                                padding: '0.7rem 0.875rem',
                                border: `1.5px solid ${errors.text_for ? '#f87171' : '#e2e8f0'}`,
                                borderRadius: '11px',
                                fontSize: '0.875rem',
                                color: '#0f172a',
                                background: '#fff',
                            ...
                            onBlur={(e) => {
                                e.target.style.borderColor = errors.text_for ? '#f87171' : '#e2e8f0';
                                e.target.style.boxShadow = 'none';
                            }}
                        >
                        ...
                        <span style={{
                            ...
                            Which section does this category belong to?
                        </span>
                        {errors.text_for && (
                            <span style={{
                                display: 'block',
                    ...
                    <div style={{ marginBottom: '1.25rem' }}>
                        ...
                        <input
                            ...
                            style={{
                                width: '100%',
                                padding: '0.7rem 0.875rem',
                                border: `1.5px solid ${errors.slug ? '#f87171' : '#e2e8f0'}`,
                                borderRadius: '11px',
                                fontSize: '0.875rem',
                                color: '#0f172a',
                                background: '#fff',
                            ...
                            onBlur={(e) => {
                                e.target.style.borderColor = errors.slug ? '#f87171' : '#e2e8f0';
                                e.target.style.boxShadow = 'none';
                            }}
                        />
                        <span style={{
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1.5rem' }}>
                        ...
                        <button
                            ...
                            onMouseEnter={e => { if (!loading) e.currentTarget.style.boxShadow = '0 8px 24px rgba(16,185,129,0.55)'; }}
                            onMouseLeave={e => { if (!loading) e.currentTarget.style.boxShadow = '0 4px 14px rgba(16,185,129,0.4)'; }}
                        >
                            {loading ? (
                                <>
                                    <span style={{

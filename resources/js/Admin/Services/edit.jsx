...
export default function AdminServiceEdit({ service }) {
    ...
    const handleSubmit = (e) => {
        ...
        payload.append('serial_number', data.serial_number || '');
    ...
    return (
        <AdminLayout title="Edit Service">
            <style>{`
                ...
                .form-input, .form-textarea { width: 100%; padding: 0.95rem 1rem; border-radius:14px; border:1px solid #e5e7eb; font-size:0.95rem; color:#0f172a; background:#fff; outline: none; transition:border-color 0.2s, box-shadow 0.2s; }
                ...
                .btn-cancel { background: transparent; color: #374151; border: 1px solid #e5e7eb; padding:0.9rem 1.3rem; border-radius: 14px; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; }

    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f8fafc', fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      {showBackToTop && (
        <button
          ...
          type="button"
        >
          <svg className="global-progress-ring" width="56" height="56">
            <circle 
              cx="28" 
              cy="28" 
              r="26" 
            ...
            <circle
              ...
              className="global-progress-circle"
            />
          </svg>
          <svg className="global-arrow-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">

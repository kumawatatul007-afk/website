...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Setting::updateOrCreate(
            ['id' => 1],
            [
                'title'           => 'MMB IT Solutions | Best Web & eCommerce Development Company in Jaipur',
                'website_title'   => 'MMB IT Solutions',
                'email'           => 'info@mmbitsolutions.com',
                'phonenumber'     => '7665544470',
                'address'         => 'MMB IT Solutions, Jaipur, Rajasthan, India',
                'social_links'    => json_encode([
                    'facebook'  => 'https://www.facebook.com/profile.php?id=61557453876608',
                    'youtube'   => 'https://www.youtube.com/@MMBitsolutions',
                    'linkedin'  => 'https://www.linkedin.com/company/mmb-it-solutions/',
                    'instagram' => 'https://www.instagram.com/mmbitsolutions',
                    'pinterest' => 'https://in.pinterest.com/mmbits77',
                    'twitter'   => 'https://x.com/MMBITSOLUTIONS',
                ]),
